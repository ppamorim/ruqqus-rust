...
impl fmt::Display for ResponseError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::InvalidAuthorizationHeader => write!(f, "Authorization token invalid"),
            ...
            Self::CreateOrganization(err) => write!(f, "Impossible to create organization; {}", err),
...
impl aweb::error::ResponseError for ResponseError {
    ...
    fn status_code(&self) -> StatusCode {
        match *self {
            ...
            Self::CreateOrganization(_) => StatusCode::BAD_REQUEST,
